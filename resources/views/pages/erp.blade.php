    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-none d-sm-inline-block">
                ...
                <a href="/erp/{{$item->id}}" class=" btn btn-sm btn-primary shadow-sm"><i class="fa-solid fa-gear fa-sm text-white-50"></i>
                    {{$item->nama}}</a>
                @endforeach
            </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$erp->implementation}}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <img src="{{asset('assets/image/'.$erp->foto)}}" alt="" srcset="" style="max-height: 300px">
                        <h6 class="mt-3 mb-3">
                            {{$erp->deskripsi}}
                        </h6>
                        <p>Link Download : <a href="{{$erp->link}}">{{$erp->link}}</a></p>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        @foreach ($erp->moduls as $item)
                            <h4 class="small font-weight-bold">{{$item->deskripsi}} <span class="float-right"><i class="fa-solid fa-check"></i></span></h4>
                        @endforeach
                    </div>
                </div>
